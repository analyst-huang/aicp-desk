...
export const LIST_AICP_PROJECTS = `
  query AicpGetAccountAllProjectList($Region: String!) {
    AicpGetAccountAllProjectList(Region: $Region) {
      Message
      RequestId
      ListProjectResult {
        Total
    ...
    DescribeClusterQueue(
      ...
      Queues {
        ...
        Status {
          ...
          Running
          Inqueue
          Allocated { cpu memory storage gpu }
        }
      }
    }
  }
...
export const DESCRIBE_GPU_INFO = `
  query DescribeGpuInfo($Region: String!, $ResourcePoolId: String!) {
    DescribeGpuInfo(Region: $Region, ResourcePoolId: $ResourcePoolId) {
      RequestId
      Gpu {
        Num
        GpuAverUtilization
...
export const DESCRIBE_RESOURCE_POOL_INSTANCES = `
  query DescribeResourcePoolInstances(
    $Region: String!
    $ResourcePoolId: String
    $Page: Float
    $PageSize: Float
