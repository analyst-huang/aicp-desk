...
test("an authenticated console target wins over a leftover passport tab", () => {
  ...
  assert.ok(waitForTarget.indexOf("if (target)") < waitForTarget.indexOf("if (passport)"));
});

test("GraphQL trace IDs are generated by Node rather than the controlled web page", () => {
